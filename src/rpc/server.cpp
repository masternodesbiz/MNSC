...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* mnsc features */
        {"mnsc", "listmasternodes", &listmasternodes, true },
        {"mnsc", "getmasternodecount", &getmasternodecount, true },
        {"mnsc", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"mnsc", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"mnsc", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"mnsc", "masternodecurrent", &masternodecurrent, true },
        {"mnsc", "startmasternode", &startmasternode, true },
        {"mnsc", "createmasternodekey", &createmasternodekey, true },
        {"mnsc", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"mnsc", "listmasternodeconf", &listmasternodeconf, true },
        {"mnsc", "getmasternodestatus", &getmasternodestatus, true },
        {"mnsc", "getmasternodewinners", &getmasternodewinners, true },
...
{
    return "> mnsc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9956/\n";
}
