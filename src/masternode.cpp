...
CAmount CMasternode::GetMasternodeNodeCollateral(int nHeight) 
{
    ...
    if (nHeight >   1150000) return   200000 * COIN;
    if (nHeight >   1100000) return   190000 * COIN;
    if (nHeight >   1050000) return   180000 * COIN;
    if (nHeight >   1000000) return   170000 * COIN;
    if (nHeight >    950000) return   160000 * COIN;
    if (nHeight >    900000) return   150000 * COIN;
    if (nHeight >    850000) return   140000 * COIN;
    if (nHeight >    800000) return   130000 * COIN;
    if (nHeight >    750000) return   120000 * COIN;
    if (nHeight >    700000) return   110000 * COIN;
    if (nHeight >    650000) return   100000 * COIN;
    if (nHeight >    600000) return    90000 * COIN;
    if (nHeight >    550000) return    80000 * COIN;
    if (nHeight >    500000) return    70000 * COIN;
    if (nHeight >    450000) return    60000 * COIN;
    if (nHeight >    400000) return    60000 * COIN;
    if (nHeight >    360000) return    50000 * COIN;
    if (nHeight >    300000) return    30000 * COIN;
    if (nHeight >    200000) return    25000 * COIN;
    if (nHeight >    100000) return    20000 * COIN;
    if (nHeight >         0) return    15000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight >   5600000) return         0 * COIN;
    if (nHeight >   2000000) return        20 * COIN;
    if (nHeight >   1400000) return        25 * COIN;
    if (nHeight >   1050000) return        30 * COIN;
    if (nHeight >    800000) return        40 * COIN;
    if (nHeight >    550000) return        45 * COIN;
    if (nHeight >    300000) return        50 * COIN;
    if (nHeight >    200000) return        45 * COIN;
    if (nHeight >    100000) return        50 * COIN;
    if (nHeight >     15000) return        55 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 mnsc tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 mnsc tx -> 1 confirmation
